...
public class OverpassAPISource implements RunnableSource {
     ...
     */
    private static Logger log = Logger.getLogger(OverpassAPISource.class.getName());
     ...
     */
    public OverpassAPISource(final double left,
                         final double right,
                         final double top,
                         final double bottom,
    ...
    public void run() {
        try {
            ...
            InputStream inputStream =
            		getInputStream(myBaseUrl + "?data=" + encoded);
            //data=[out:json]
